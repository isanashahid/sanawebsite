    ...
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            <div className="relative inline-flex items-center gap-2 px-6 py-3 rounded-full backdrop-blur-xl group">
              {/* Animated gradient background */}
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 via-purple-500/20 to-pink-500/20 rounded-full animate-pulse" />
              
              {/* Border glow effect */}
              <div className="absolute inset-0 rounded-full border-2 border-transparent bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-border opacity-50 group-hover:opacity-100 transition-opacity" 
                   style={{ 
              ...
              <div className="absolute inset-[2px] bg-gradient-to-r from-cyan-900/40 via-purple-900/40 to-pink-900/40 rounded-full backdrop-blur-2xl" />
              
              {/* Content */}
              <div className="relative flex items-center gap-2">
                <Sparkles className="text-cyan-400 animate-pulse" size={20} />
                <span className="text-cyan-400 font-semibold tracking-wide text-sm md:text-base">
